    ...
    <Card sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' } }}>
        <Box sx={{ display: 'flex', flexDirection: 'column', minWidth: 300 }}>
            <CardContent sx={{ flex: '1 0 auto' }}>
                ...
                <Typography>
                    One person creates a room and shares the room link or ID for the other players to join. Players enter a famous person so others do not know who they have chosen.
                    Once all names have been entered, the room creator will then read the names out loud once or twice. Once the game has begun - the names are NOT to be read out again. It is up to the players to remember what names have been read out.
                </Typography>
                <Typography>
